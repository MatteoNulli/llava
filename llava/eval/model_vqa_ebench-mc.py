        ...
        for round_idx in range(num_rounds):
            ...
            if args.context and args.shots == 0:
                ...
                if model.config.mm_use_im_start_end:
                    qs = qs + DEFAULT_IM_START_TOKEN + DEFAULT_IMAGE_TOKEN + DEFAULT_IM_END_TOKEN + '\n'
                elif args.gpt4o or args.llama90b or args.phi3 or args.molmo or args.qwen2 or args.pixtral or args.llama3_2 or args.aria:
                    qs = qs + '\n'
                else:
                ...
                if not args.pixtral:        
                    ...
                    if model.config.mm_use_im_start_end:
                        ...
                        if not (args.gpt4o or args.llama90b or args.phi3 or args.molmo or args.qwen2 or args.pixtral or args.llama3_2 or args.aria):
