...
# from ezcolorlog import root_logger as logger ##removed logger.info --> print because of no support for ezcolorlog
...
def build_vision_tower_aux_list(vision_tower_cfg, **kwargs):
    ...
    for vision_tower_aux_name, vision_tower_aux_token_len in zip(vision_tower_aux_name_list, vision_tower_aux_token_len_list):
        ...
        if "maws" in vision_tower_aux_name.lower():
            print(f"Loading **MAWS** Vision Tower: {vision_tower_aux_name}")
        ...
        # CLIP-based Vision Towers
            ...
            print(f"Loading **OpenAI CLIP** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **Apple DFN CLIP** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **SigLIP CLIP** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **EVA CLIP** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **ConvNeXt CLIP** Vision Tower: {vision_tower_aux_name}")
        ...
        # SSL-based Vision Towers
            ...
            print(f"Loading **DINO Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **MAE** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **MoCo** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **IJepa** Vision Tower: {vision_tower_aux_name}")
        ...
        # Supervised Vision Towers
            ...
            print(f"Loading **Supervised** Vision Tower: {vision_tower_aux_name}")
        ...
        # Other Vision Towers
            ...
            print(f"Loading **Hybrid** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **Diffusion CLIP** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **MiDaS** Vision Tower: {vision_tower_aux_name}")
            ...
            print(f"Loading **SAM Vision Tower: {vision_tower_aux_name}")
